...
from dataclass_factory.feature_requirement import HAS_STD_CLASSES_GENERICS
from dataclass_factory.type_tools import is_named_tuple_class, is_protocol, is_user_defined_generic
from dataclass_factory.type_tools.basic_utils import is_parametrized
